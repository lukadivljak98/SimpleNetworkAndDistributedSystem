...
public class SoapLogInServiceLocator extends org.apache.axis.client.Service implements soap.SoapLogInService {
    ...
    private java.lang.String SoapLogIn_address = "http://localhost:4200/CZSServer/services/SoapLogIn";
    ...
    public soap.SoapLogIn getSoapLogIn() throws javax.xml.rpc.ServiceException {
    ...
    public soap.SoapLogIn getSoapLogIn(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.SoapLogInSoapBindingStub _stub = new soap.SoapLogInSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soap.SoapLogIn.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.SoapLogInSoapBindingStub _stub = new soap.SoapLogInSoapBindingStub(new java.net.URL(SoapLogIn_address), this);
                _stub.setPortName(getSoapLogInWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap", "SoapLogInService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap", "SoapLogIn"));
        }
